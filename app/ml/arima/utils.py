...
def validate_minimum_length(series: pd.Series, min_length: int = 50) -> dict:
    ...
    return {
        ...
        'aviso': (
            f"No hay suficientes datos para entrenar ARIMA/SARIMA. "
            f"Tu dataset tiene {longitud} observaciones y se necesitan al menos {min_length}. "
            f"Con pocos datos los parámetros del modelo no se pueden estimar de forma fiable. "
            f"Prueba a usar Prophet, que funciona mejor con series cortas."
